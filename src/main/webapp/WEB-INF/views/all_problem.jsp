			...
			success : function(data){
				...
				for(var i=0;i<list.length;i++){
					...
					"<tr class='del'><td>.</td><td onclick='aa(" + list[i].proplemId + ")'>"
									+ list[i].proplemTitle + "</td>" + "<td class='bbb'style='position: relative; left: 50px;'>"
...
<body>
	...
	<tr></tr>
		...
		<div id="neirong">
			...
			<table id="table" style="margin-top: 200px;margin-left: 40px; height: 200px;font-size: 14px;">
	...
	<div id="rightmodle">
		<div id="righthead">
			...
			<div id="information" style="width: 600px;">
				<h4 id="title"></h4>
				<p id="auther"></p>
				<p id="rong"></p>
			</div>
		...
		<div id="righttext">
			...
			<div id="sumbit" align="center" style="display: block;">
				<input type="button" value="提交回复" onclick="backInfo1()">
			</div>
		</div>
	</div>
</body>
